    ...
    >
      ...
      <div>
        ...
        <input
          type="file"
          accept="image/*"
          className="w-full text-xs md:text-sm text-gray-500 file:mr-3 md:file:mr-4 file:py-2 file:px-3 md:file:px-4 file:rounded-lg file:border-0 file:text-xs md:file:text-sm file:font-medium file:bg-[#2a2a2a] file:text-[#d4ff00] hover:file:bg-[#333333] file:cursor-pointer cursor-pointer"
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-white text-black font-semibold py-2.5 md:py-3 px-4 md:px-6 rounded-xl hover:bg-gray-100 transition-colors flex items-center justify-center gap-2 mt-4 md:mt-6 text-sm md:text-base"
      >
        {loading ? (
